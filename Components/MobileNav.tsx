...
const MobileNav = ({nav,closeNav}:Props) => {
  ...
  return (
    ...
    >
        ...
        <div onClick={closeNav}  className="nav-link-mobile text-white"><Link href="/">HOME</Link> </div>
        <div onClick={closeNav}  className="nav-link-mobile text-white"><Link href="/#AboutMe">ABOUT</Link></div>
        <div onClick={closeNav}  className="nav-link-mobile text-white"><Link href="/#Skills">SKILLS</Link></div>        
        <div onClick={closeNav}  className="nav-link-mobile text-white"><Link href="/#Projects">PROJECTS</Link></div>    
    {/* LinkedIn Icon */}
    <div className="nav-link-mobile" > 
        <a href="https://www.linkedin.com/in/gagnierjoshua/" target="_blank">  
        <svg className="h-8 w-8 text-white"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1"  stroke-linecap="round"  stroke-linejoin="round">  
  ...
  {/* GH Icon */}
      ...
      <svg className="h-8 w-8 text-white"  width="24" height="24" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  
