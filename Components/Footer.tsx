    ...
    <div className="bg-[#121212] pt-[4rem] md:pt-[8rem] pb-[5rem]">
        ...
        <div className="flex items-center space-x-6">
                ...
                href="https://www.linkedin.com/in/gagnierjoshua/">   
                    <svg className="md:w-[5rem] md:h-[rem] w-[3rem] h-[3em] text-[#55e6a5]"  viewBox="0 0 24 24"  fill="green-400"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  
        ...
        <div className="flex items-center space-x-6">
                ...
                href="https://github.com/gagnierjoshua">      
                 <svg className="md:w-[rem] md:h-[rem] w-[3rem] h-[3rem] text-[#55e6a5]"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  
         ...
         <div className="flex items-center space-x-6">
                ...
                <svg className="md:w-[5rem] md:h-[rem] w-[3rem] h-[3em] text-[#55e6a5]"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"> 
