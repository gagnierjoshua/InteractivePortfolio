...
const Nav = ({openNav}:Props) => {
  ...
  return (<div className="w-[100%] sticky z-[10000] top-0 h-[12vh] bg-[#141c27] shadow-md">
    <div className="flex items-center justify-between w-[80%] mx-auto h-[100%]">
        ...
        <div className="nav-link text-white"><Link href="/#AboutMe">ABOUT</Link></div>  
        <div className="nav-link text-white"><Link href="/#Skills">SKILLS</Link></div>              
          ...
          {isDropdownVisible && (
            <div className="absolute left-0 mt-0 w-22 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
              <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                ...
                <a href="#" className="block px-2 py-2 text-sm text-gray-700 hover:bg-green-100" role="menuitem"><Link href="/#Projects">General</Link></a>
               <a href="#" className="block px-2 py-2 text-sm text-gray-700 hover:bg-green-100" role="menuitem"> <Link href="/Web" >Web </Link></a>
                <a href="#" className="block px-2 py-2 text-sm text-gray-700 hover:bg-green-100" role="menuitem"><Link href="/Game" >Game </Link></a>
                <a href="#" className="block px-2 py-2 text-sm text-gray-700 hover:bg-green-100" role="menuitem"><Link href="/Embedded" >Embedded </Link></a>
                <a href="#" className="block px-2 py-2 text-sm text-gray-700 hover:bg-green-100" role="menuitem"><Link href="/Data" >AI & Data </Link></a>
              </div>
            </div>
          )}
        </div>
    {/* LinkedIn Icon */}
        ...
        <svg className="h-4 w-4 text-white"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1"  stroke-linecap="round"  stroke-linejoin="round">  
  ...
  {/* GH Icon */}
      ...
      <svg className="h-4 w-4 text-white"  width="24" height="24" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  
